        ...
        <div className="contact-wrapper">
          <div className="contact-info">
            ...
            <p className="contact-lead">
              ...
              you find the perfect healthcare solutions for your needs.
            </p>
            ...
            <div className="social-links">
              <a href="https://www.linkedin.com/company/sereene/" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="LinkedIn">
                <svg
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <a href="https://www.instagram.com/sereene.in/" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="Instagram">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                ...
                >
                  ...
                  <option value="medical-apparels">Medical Apparels</option>
                  <option value="hygiene">Hygiene Products</option>
                  <option value="packaging">Medical Packaging</option>
