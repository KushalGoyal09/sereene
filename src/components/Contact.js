        ...
        <div className="contact-wrapper">
          <div className="contact-info">
            ...
            <p className="contact-lead">
              Have questions or need more information? We&apos;re here to help you find the perfect healthcare solutions for your needs.
            </p>
            <div className="contact-details">
              <div className="contact-item">
                ...
                <div className="contact-text">
                  <h4>Visit Us</h4>
                  <p>Healthcare Plaza, 5th Floor<br/>Medical District, New York, NY 10001</p>
                </div>
              </div>
              <div className="contact-item">
                <div className="contact-icon">
              ...
              <div className="contact-item">
                ...
                <div className="contact-text">
                  <h4>Email Us</h4>
                  <p>info@sereene.com<br/>support@sereene.com</p>
                </div>
              </div>
            </div>
